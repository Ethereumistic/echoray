...
export const seedData = mutation({
    ...
    handler: async (ctx) => {
        ...
        const tiers = [
            ...
            { name: "Web", slug: "web", priceEur: 99, isCustom: false, basePermissions: 1, maxMembers: 5, maxOrganizations: 3 },
            { name: "App", slug: "app", priceEur: 299, isCustom: false, basePermissions: 3, maxMembers: 20, maxOrganizations: 10 },
            { name: "CRM", slug: "crm", priceEur: 0, isCustom: true, basePermissions: 7, maxOrganizations: 100 },
        ];
        ...
        const permissions = [
            ...
            // Admin permissions
            { code: "org.settings", bitPosition: 12, name: "Manage Organization Settings", category: "admin", isAddon: false, isDangerous: true },
            { code: "members.invite", bitPosition: 13, name: "Invite Members", category: "admin", isAddon: false, isDangerous: false },
            { code: "members.remove", bitPosition: 14, name: "Remove Members", category: "admin", isAddon: false, isDangerous: true },
            { code: "roles.manage", bitPosition: 15, name: "Manage Roles", category: "admin", isAddon: false, isDangerous: true },
            { code: "billing.view", bitPosition: 16, name: "View Billing", category: "billing", isAddon: false, isDangerous: false },
            { code: "billing.manage", bitPosition: 17, name: "Manage Billing", category: "billing", isAddon: false, isDangerous: true },

            // Addons
            { code: "integrations.zapier", bitPosition: 18, name: "Zapier Integration", category: "integrations", minTier: "web", isAddon: true, addonPriceEur: 29, isDangerous: false },
            { code: "integrations.slack", bitPosition: 19, name: "Slack Integration", category: "integrations", minTier: "web", isAddon: true, addonPriceEur: 19, isDangerous: false },
            { code: "storage.extended", bitPosition: 20, name: "Extended Storage (100GB)", category: "storage", minTier: "web", isAddon: true, addonPriceEur: 49, isDangerous: false },
            { code: "support.priority", bitPosition: 21, name: "Priority Support", category: "support", minTier: "web", isAddon: true, addonPriceEur: 99, isDangerous: false },
        ];
