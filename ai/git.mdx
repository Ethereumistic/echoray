# 🏗 Echoray Project Architecture & Refactoring Plan
...
2. **`echoray-app`**: The internal dashboard and CRM built with **TanStack Start**. This handles project management, pricing control, and business logic.
...
├── /echoray-web (Current Next.js Project)
│   ├── .git/
│   ├── src/
│   ├── wrangler.jsonc
│   └── ...
└── /echoray-app (New TanStack Start Project)
    ├── .git/
    ├── src/
    └── ...
```
...
2. Initialize **TanStack Start** inside this directory.
